...
e_mail = 'stanislav311213@gmail.com'
passw = 'es311213'
...
def test_show_my_pets():
   # Вводим email
   pytest.driver.find_element(By.ID, "email").send_keys('stanislav311213@gmail.com')
   # Вводим пароль
   pytest.driver.find_element(By.ID, "pass").send_keys('es311213')
